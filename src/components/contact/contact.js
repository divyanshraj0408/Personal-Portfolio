    ...
    <>
      <div className="container contact-me__section">
        <div className="info-head">
          <h2>
            .contact ☎️ <span className="comments">// hit me up</span>
          </h2>
        </div>
        <div className="contact-section row">
          <div className="link-section">
            <p>
              I am always up for talks about tech and also hardware side of
              things, so if you have anything in mind or have any new project
              idea, contact me right away.⚜️
            </p>
          </div>
